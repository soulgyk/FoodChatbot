...
@app.post("/")  # Updated route to match ngrok URL
...
def complete_order(parameters: dict , session_id: str):
    if session_id not in inprogress_orders:
        fulfillment_text = "I'm having a trouble finding your order. Sorry!, can yu place a new order."
    else:
        ...
        if order_id == -1:
            ...
            fulfillment_text = f"Awesome. We have placed you order. " \
